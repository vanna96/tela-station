...
class Details extends Component<any, any> {
  ...
  navigateToSalesOrder = () => {
    ...
    history.push("/stock-control/good-receipt");
  };
        ...
        <div className="grid grid-cols-12 ">
          <div className="col-span-5">
            ...
            <div className="grid grid-cols-2 py-2">
              ...
              <div className="col-span-1 text-gray-900">
                {props.data.CardCod ?? "N/A"}
              </div>
            </div>
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Truck No.</div>
              <div className="col-span-1 text-gray-900">
                {props.data.CardName ?? "N/A"}
              </div>
            </div>
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Revenue Line</div>
              <div className="col-span-1 text-gray-900">
            ...
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Ship To</div>
              <div className="col-span-1 text-gray-900">
          ...
          <div className="col-span-5 ">
            ...
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Good Issue Type </div>
              <div className="col-span-1 text-gray-900">
                {props?.data?.vendor?.contactEmployee?.find(
                  (e: any) => e.id == props.data.ContactPersonCode
                )?.name ?? "N/A"}
            ...
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Sale Type</div>
              <div className="col-span-1 text-gray-900">
                {props?.data?.Comments ?? "N/A"}
              </div>
            </div>
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Ref No.</div>
              <div className="col-span-1 text-gray-900">
                {props?.data?.ref ?? "N/A"}
              </div>
            </div>
            <div className="grid grid-cols-2 py-2">
              <div className="col-span-1 text-gray-700 ">Offset Account</div>
              <div className="col-span-1 text-gray-900">
                {props?.data?.ref ?? "N/A"}
              </div>
            </div>
