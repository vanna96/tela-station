    ...
    () => [
      {
        ...
        header: "Pump ID", //uses the default width from defaultColumn prop
      ...
      },
      {
        ...
        size: 60,
        Cell: ({ cell }: any) => {
          return new UsersRepository().find(cell.getValue())?.UserCode;
        },
      },
    ],
    [data]
      ...
      <div className="rounded-lg shadow-sm bg-white border p-8 px-14 h-full">
        ...
        <div className="overflow-y-auto max-h-[calc(100vh-100px)]">
          <MaterialReactTable
            ...
            columns={itemColumn}
            data={data?.TL_PUMP_TEST_LINESCollection || []}
            muiTableProps={{
              sx: {
