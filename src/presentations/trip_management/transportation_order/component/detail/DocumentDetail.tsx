...
export default function DocumentDetail(props: any) {
    ...
    <>
      <div className="rounded-lg shadow-sm  border p-6 m-3 px-8 h-full">
        <div className="font-medium text-lg flex gap-x-3 items-center mb-5 pb-1">
          <h2 className="mr-3 text-[15px]">Source Document</h2>
        </div>{" "}
        <div>
          <table className="border w-full text-[13px] shadow-sm bg-white border-[#dadde0]">
                          ...
                          <>
                            ...
                            <tr key={index} className="">
                              ...
                              <td className="pr-4 bg-gray-50 border-l-[1px] border-[#dadde0]">
                                <span className="text-black flex items-center gap-3 text-[13.5px] ml-1 px-4">
                                  {c?.U_DocType}
                                </span>
                              </td>
