...
export default function LogisticForm({
  ...
  return (
    <FormCard title="Accounting" ref={ref}>
      ...
      <div>
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1 text-sm">
            <label htmlFor="JournalMemo" className="text-gray-500 text-[14px]">
              Journal Remark
            </label>
            <div className="">
              <TextField
                size="small"
                value={`Sale Orders - ${data?.CardCode}`}
                fullWidth
                className="w-full text-field"
                name="JournalMemo"
          ...
          <div className="flex flex-col gap-1 text-sm">
            ...
            <div className="">
              <PaymentTerm
                name="PaymentTerms"
                disabled={data?.disable["PaymentTermType"]}
                value={data.PaymentTermType}
                onChange={(e) =>
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex flex-col gap-1 text-sm">
              ...
              <div className="">
                ...
                >
                   <MenuItem value=""> - Payment Method - </MenuItem>
                  {data?.vendor?.bpPaymentMethod?.map(
                    (e: any, index: number) => (
                      <MenuItem key={index} value={e.PaymentMethodCode}>
                        {e.PaymentMethodCode}
                      </MenuItem>
                ...
                <MUISelect
                  value={data?.PaymentMethod || ""}
                  items={data?.vendor?.bpPaymentMethod?.map(
                    (e: any, index : number) => ({
