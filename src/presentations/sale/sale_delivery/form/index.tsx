...
class DeliveryForm extends CoreFormDocument {
  ...
  async onInit() {
    ...
    let defaultSeries: any = this.props?.query?.find("delivery-default-series")
    ...
    if (!defaultSeries) {
      ...
      this.props?.query?.set("delivery-default-series", defaultSeries)
    }
  ...
  async handlerSubmit(event: any) {
    ...
    try {
      ...
      if (id) {
        return await request("PATCH", `/DeliveryNotes(${id})`, payloads)
          .then((res: any) =>
