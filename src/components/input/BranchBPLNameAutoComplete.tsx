...
export default function BranchBPLNameAutoComplete(props: {
  label?: any;
  value?: any;
  ...
  useEffect(() => {
    ...
    if (props.value) {
      const selected = data?.find((e: Type) => e.BPLName === props.value);
      if (selected) {
  ...
  const handleAutocompleteChange = (event: any, newValue: any) => {
    ...
    if (props.onChange) {
      ...
      const selectedV = newValue ? newValue?.BPLName : null;
