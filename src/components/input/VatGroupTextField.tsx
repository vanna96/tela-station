...
const VatGroupTextField: FC<VatGroupTextField> = ({ value, onChange, name, type, disabled, label, status = '' }: VatGroupTextField) => {
    ...
    return <>
        <VatGroupModal type={type} open={open} onClose={onClose} onOk={handlerConfirm} status={status} />
