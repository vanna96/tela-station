...
import ReasonRepository from "@/services/actions/ReasonRepository";
...
export default function ReasonAutoComplete(props: {
  label?: any;
  value?: any;
  ...
  const { data, isLoading }: any = useQuery({
    queryKey: ["reason"],
    queryFn: () => new ReasonRepository().get(),
    staleTime: Infinity,
  });
  ...
  const handleAutocompleteChange = (event: any, newValue: any) => {
    ...
    if (props.onChange) {
      ...
      const selectedCode = newValue ? newValue.ReasonID : null;
