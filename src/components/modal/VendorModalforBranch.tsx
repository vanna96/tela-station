...
//     queryKey: ["venders_branch"],
//     queryFn: () => new BranchQueryRepository().get(),
//     staleTime: Infinity,
//   });
...
//             await new BusinessPartnerRepository().find(selectedCardCode);

//           console.log(businessPartnerData);
//           if (businessPartnerData) {
//             const businessPartner = new BusinessPartner(businessPartnerData, 0);
//             // console.log("Created business partner:", businessPartner); // Debugging line
...
const VendorModalBranch: FC<VendorModalProps> = ({
  ...
  useEffect(() => {
    if (businessPartnerData) {
      const businessPartner = new BusinessPartner(businessPartnerData, 0);
      // console.log(["vanna", businessPartnerData])
      onOk(businessPartner);
    }
  }, [businessPartnerData]);
